...
SOURCEFILES_QUOTED_IF_SPACED=CB_Timer3.c CB_Timer1.c CB_I2C.c CB_Bluetooth.c CB_Inicializaciones.c CB_Timer2.c main.c Pruebas.c CA_SetGetMPU6050.c CA_calibrado_y_filtros.c CB_Timer5.c CA_funciones_control.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/CB_Timer3.o ${OBJECTDIR}/CB_Timer1.o ${OBJECTDIR}/CB_I2C.o ${OBJECTDIR}/CB_Bluetooth.o ${OBJECTDIR}/CB_Inicializaciones.o ${OBJECTDIR}/CB_Timer2.o ${OBJECTDIR}/main.o ${OBJECTDIR}/Pruebas.o ${OBJECTDIR}/CA_SetGetMPU6050.o ${OBJECTDIR}/CA_calibrado_y_filtros.o ${OBJECTDIR}/CB_Timer5.o ${OBJECTDIR}/CA_funciones_control.o
...
# Object Files
OBJECTFILES=${OBJECTDIR}/CB_Timer3.o ${OBJECTDIR}/CB_Timer1.o ${OBJECTDIR}/CB_I2C.o ${OBJECTDIR}/CB_Bluetooth.o ${OBJECTDIR}/CB_Inicializaciones.o ${OBJECTDIR}/CB_Timer2.o ${OBJECTDIR}/main.o ${OBJECTDIR}/Pruebas.o ${OBJECTDIR}/CA_SetGetMPU6050.o ${OBJECTDIR}/CA_calibrado_y_filtros.o ${OBJECTDIR}/CB_Timer5.o ${OBJECTDIR}/CA_funciones_control.o

# Source Files
SOURCEFILES=CB_Timer3.c CB_Timer1.c CB_I2C.c CB_Bluetooth.c CB_Inicializaciones.c CB_Timer2.c main.c Pruebas.c CA_SetGetMPU6050.c CA_calibrado_y_filtros.c CB_Timer5.c CA_funciones_control.c
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/quad.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
<<<<<<< HEAD
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/quad.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf  -mreserve=data@0x800:0x81F -mreserve=data@0x820:0x821 -mreserve=data@0x822:0x823 -mreserve=data@0x824:0x84F   -Wl,--defsym=__MPLAB_BUILD=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST) 
=======
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/quad.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -Wl,--defsym=__MPLAB_BUILD=1,--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST) 
