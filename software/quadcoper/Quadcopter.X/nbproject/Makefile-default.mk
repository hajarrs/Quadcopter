...
SOURCEFILES_QUOTED_IF_SPACED=CB_Inicializaciones.c CB_Timer1.c CB_Timer2.c CB_Timer3.c CB_Timer5.c Pruebas.c main.c CA_calibrado_filtro.c CA_calibrado_y_filtros.c CA_funciones_control.c CA_kalman.c CA_SetGetMPU6050.c CB_Bluetooth.c CB_I2C.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/CB_Inicializaciones.o ${OBJECTDIR}/CB_Timer1.o ${OBJECTDIR}/CB_Timer2.o ${OBJECTDIR}/CB_Timer3.o ${OBJECTDIR}/CB_Timer5.o ${OBJECTDIR}/Pruebas.o ${OBJECTDIR}/main.o ${OBJECTDIR}/CA_calibrado_filtro.o ${OBJECTDIR}/CA_calibrado_y_filtros.o ${OBJECTDIR}/CA_funciones_control.o ${OBJECTDIR}/CA_kalman.o ${OBJECTDIR}/CA_SetGetMPU6050.o ${OBJECTDIR}/CB_Bluetooth.o ${OBJECTDIR}/CB_I2C.o
POSSIBLE_DEPFILES=${OBJECTDIR}/CB_Inicializaciones.o.d ${OBJECTDIR}/CB_Timer1.o.d ${OBJECTDIR}/CB_Timer2.o.d ${OBJECTDIR}/CB_Timer3.o.d ${OBJECTDIR}/CB_Timer5.o.d ${OBJECTDIR}/Pruebas.o.d ${OBJECTDIR}/main.o.d ${OBJECTDIR}/CA_calibrado_filtro.o.d ${OBJECTDIR}/CA_calibrado_y_filtros.o.d ${OBJECTDIR}/CA_funciones_control.o.d ${OBJECTDIR}/CA_kalman.o.d ${OBJECTDIR}/CA_SetGetMPU6050.o.d ${OBJECTDIR}/CB_Bluetooth.o.d ${OBJECTDIR}/CB_I2C.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/CB_Inicializaciones.o ${OBJECTDIR}/CB_Timer1.o ${OBJECTDIR}/CB_Timer2.o ${OBJECTDIR}/CB_Timer3.o ${OBJECTDIR}/CB_Timer5.o ${OBJECTDIR}/Pruebas.o ${OBJECTDIR}/main.o ${OBJECTDIR}/CA_calibrado_filtro.o ${OBJECTDIR}/CA_calibrado_y_filtros.o ${OBJECTDIR}/CA_funciones_control.o ${OBJECTDIR}/CA_kalman.o ${OBJECTDIR}/CA_SetGetMPU6050.o ${OBJECTDIR}/CB_Bluetooth.o ${OBJECTDIR}/CB_I2C.o

# Source Files
SOURCEFILES=CB_Inicializaciones.c CB_Timer1.c CB_Timer2.c CB_Timer3.c CB_Timer5.c Pruebas.c main.c CA_calibrado_filtro.c CA_calibrado_y_filtros.c CA_funciones_control.c CA_kalman.c CA_SetGetMPU6050.c CB_Bluetooth.c CB_I2C.c
...
${OBJECTDIR}/CA_calibrado_filtro.o: CA_calibrado_filtro.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/CA_calibrado_filtro.o 
...
${OBJECTDIR}/CA_calibrado_y_filtros.o: CA_calibrado_y_filtros.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/CA_calibrado_y_filtros.o 
...
dist/${CND_CONF}/${IMAGE_TYPE}/Quadcopter.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Quadcopter.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf  -mreserve=data@0x800:0x81F -mreserve=data@0x820:0x821 -mreserve=data@0x822:0x823 -mreserve=data@0x824:0x84F   -Wl,--defsym=__MPLAB_BUILD=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST) 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/Quadcopter.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Quadcopter.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -omf=elf -Wl,--defsym=__MPLAB_BUILD=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST) 
