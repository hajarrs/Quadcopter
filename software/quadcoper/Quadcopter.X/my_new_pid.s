 ...
 * Author: Raul
 *
 * Created on 12 de marzo de 2014, 11:52
 */
...
_PID:
        ...
        lac     w3, a                   ; A = tPID.controlReference    GUARDA EN EL ACUMULADOR A EL CONTENIDO DE w3
        lac     w2, b                   ; B = tPID.MeasuredOutput	   GUARDA EN EL ACUMULADOR B EL CONTENIDO DE w2
        sub     a                       ; A = tPID.controlReference - tPID.measuredOutput     RESTA LOS ACUMULADORES
        sac.r   a, [w10]                ; tPID.ControlHistory[n] = Sat(Rnd(A))   GUARDA EL RESULTADO EN w10
